	...
	return (
		<main className="flex h-full w-full max-w-5xl flex-1 flex-col md:w-3/4 md:border-r xl:w-2/3">
			<article
				...
				className="shadow-on-scrollbox flex min-h-0 w-full flex-1 flex-col gap-12 overflow-x-hidden overflow-y-scroll px-3 py-4 pt-6 scrollbar-thin scrollbar-thumb-scrollbar md:px-10 md:py-12 md:pt-16"
			>
				<div>
